...
/**
 * 제조사는 실명과 거래 관계를 제외한 공개용 초기 목록이다.
 *
 * ⚠️ 규칙 3가지 — 고치더라도 이건 지킨다.
 *  1. 실존 거래처·제조사 실명 금지. 실제 이름과 인허가번호는 공개 파일에 넣지 않는다.
...
export const seedManufacturers: Manufacturer[] = [
  {
    id: "mfr-01",
    displayName: "제조 01 (충북)",
    region: "충북",
    certifications: [],
    dosageForms: ["정제", "분말", "분말스틱", "스낵"],
    equipmentSummary: "혼합·타정·분말 포장·곡물 가공",
    moqRange: "확인 필요",
    leadTimeWeeks: null,
    isActive: true,
  },
  {
    id: "mfr-02",
    displayName: "제조 02 (경기)",
    region: "경기",
    certifications: [],
    dosageForms: ["정제"],
    equipmentSummary: "혼합·타정·병 포장",
    moqRange: "확인 필요",
    leadTimeWeeks: null,
    isActive: true,
  },
  {
    id: "mfr-03",
    displayName: "제조 03 (충북)",
    region: "충북",
    certifications: [],
    dosageForms: ["정제", "경질캡슐", "연질캡슐", "분말", "과립", "퀵멜트", "액상"],
    equipmentSummary: "정제·캡슐·분말·액상 제조 및 포장",
    moqRange: "확인 필요",
    leadTimeWeeks: null,
    isActive: true,
  },
  {
    id: "mfr-04",
    displayName: "제조 04 (전북)",
    region: "전북",
    certifications: [],
    dosageForms: ["정제", "경질캡슐", "연질캡슐", "분말", "분말스틱", "과립", "액상", "젤리", "환"],
    equipmentSummary: "액상·젤리와 고형제 생산 라인",
    moqRange: "확인 필요",
    leadTimeWeeks: null,
    isActive: true,
  },
  {
    id: "mfr-05",
    displayName: "제조 05 (충북)",
    region: "충북",
    certifications: [],
    dosageForms: ["분말", "정제", "캡슐", "액상", "젤리"],
    equipmentSummary: "타정·캡슐 충전·PTP·액상/젤리 충전",
    moqRange: "확인 필요",
    leadTimeWeeks: null,
    isActive: true,
  },
  {
    id: "mfr-06",
    displayName: "제조 06 (경북)",
    region: "경북",
    certifications: [],
    dosageForms: ["분말", "액상", "젤리"],
    equipmentSummary: "분말·스파우트·스틱·파우치 충전",
    moqRange: "확인 필요",
    leadTimeWeeks: null,
    isActive: true,
  },
